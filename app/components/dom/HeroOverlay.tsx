...
export default function HeroOverlay() {
  return (
    <div className="absolute inset-0 z-10 flex flex-col items-center justify-center overflow-y-auto overflow-x-hidden no-scrollbar pl-safe pr-safe pt-20 landscape:pt-16 pb-24 landscape:pb-12 landscape:justify-start lg:landscape:justify-center lg:landscape:pt-0 lg:landscape:pb-0">
      <div className="w-full px-6 flex flex-col items-center">
        <div className="animate-slide-up max-w-lg md:max-w-2xl w-full py-4 text-center landscape:py-2 lg:landscape:py-4">
          <p className="text-sm sm:text-base md:text-lg text-foreground mb-2 landscape:mb-1 landscape:text-xs lg:landscape:text-lg lg:landscape:mb-2">
            Hello There 👋, I&apos;m
          </p>
          ...
          <div className="flex flex-wrap items-center justify-center gap-3 sm:gap-6 mb-6 md:mb-12 landscape:mb-4 landscape:gap-2 lg:landscape:gap-6 lg:landscape:mb-12">
            ...
            <div className="glass px-4 py-2 sm:px-6 sm:py-3 rounded-lg landscape:px-3 landscape:py-1 lg:landscape:px-6 lg:landscape:py-3">
              ...
              <p className="text-xs sm:text-sm text-foreground/60 landscape:text-[10px] lg:landscape:text-sm">Responses Time</p>
            </div>
          </div>
