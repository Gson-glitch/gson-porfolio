...
export default function HeroOverlay() {
  return (
    <div className="absolute inset-0 z-10 flex flex-col items-center justify-center px-4 text-center overflow-y-auto overflow-x-hidden no-scrollbar pl-safe pr-safe pt-20 landscape:pt-16 pb-24 landscape:pb-12 landscape:justify-start lg:landscape:justify-center lg:landscape:pt-0 lg:landscape:pb-0">
